...
#use-case(
        ...
        scenario-principale:[
          + Companion invia una query di ricerca linked
...
#use-case(
        codice: "UC-03",
        nome: "Invia query ricerca linked",
        attore-principale:"Companion",
        attore-secondario: none,
        pre-condizioni: [
...
#use-case(
        codice: "UC-02.4.1",
        nome: "Ricerca ibrida linked rrf",
        attore-principale:"Companion",
        attore-secondario: "Modello di embedding",
        pre-condizioni: [
                - Il sistema è attivo
...
#use-case(
        codice: "UC-02.4.2",
        nome: "Ricerca ibrida linked modello di rerank",
        attore-principale:"Companion",
