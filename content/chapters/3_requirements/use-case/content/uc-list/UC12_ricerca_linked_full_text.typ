...
#let use-case-nome="Ricerca linked full-text"
// #let depth=
...
//                - Companion riceve solo il chunk di testo su cui è stato trovato un match
        ...
        scenario-principale:[
                ...
                + Il sistema di ricerca può ottimizzare la ricerca basandosi sulla lingua
                + Companion riceve i risultati #sym.arrow #utils.uc-link("ricezione risultati ricerca linked")
        ],
        scenari-alternativi:none,
        trigger: [Companion vuole eseguire una ricerca full-text su tutte le entità],
        inclusioni: none,
        estensioni: none,
