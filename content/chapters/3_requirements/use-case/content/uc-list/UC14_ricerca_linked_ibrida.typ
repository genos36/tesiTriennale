...
#let use-case-nome="Ricerca linked ibrida"
// #let depth=
#let diagram=none
...
#use-case(
        alt-diagramma:"Questo diagramma dei casi d'uso rappresenta la realizzazione della ricerca ibrida linked",
...
//                - Companion riceve solo il chunk di testo su cui è stato trovato un match
        ...
        scenario-principale:[
                ...
                + Il sistema di ricerca fonde i risultati
