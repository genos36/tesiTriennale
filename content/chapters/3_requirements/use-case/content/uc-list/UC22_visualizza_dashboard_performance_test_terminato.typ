...
#use-case(
        ...
        pre-condizioni:[
                ...
                - Nel sistema di test non sono in corso run di test
        ],
        post-condizioni: [
                - Il supervisore ha visualizzato lo stato dell'ultima run di test avviata
                        ],
        scenario-principale:[
                + Il sistema di test calcola una singola volta i dati da mostrare
        ...
        scenari-alternativi:[
                - Nel sistema di test non vi sono run di test registrate #sym.arrow #utils.uc-link("Nessuna run di test trovata")
        ],
        trigger: none,
        inclusioni: none,
        estensioni: none,
