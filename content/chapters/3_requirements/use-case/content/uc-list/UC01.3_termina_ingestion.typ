...
#let diagram=none
  ...
  ext-actors: (),
  includes: (),
  extends: ("Errore termine ingestion":"Nel sistema di ricerca è ancora in corso l'elaborazione dei dati"),
  generalizations: (),
  spacing: (1cm, 1cm),
  width: 100%,
  max-height: none,
...
#use-case(
        alt-diagramma:"Questo diagramma dei casi d'uso rappresenta il processo per concludere una sessione di ingestion",
        ...
        post-condizioni: [
                - Nel sistema di ricerca viene chiusa la sessione di ingestion
                        ],
        scenario-principale:[
                + Companion chiede il termine della sessione di ingestion
                + Il sistema di ricerca rende i dati disponibili per la ricerca
