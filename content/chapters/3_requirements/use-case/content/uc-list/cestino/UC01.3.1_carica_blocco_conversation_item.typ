...
#let diagram=none
  ...
  parent-uc: "Ingestion lista conversation item",             // Nome mostrato sulla linguetta; default = target-uc
...
#use-case(
        ...
        post-condizioni: [
                - Il sistema di ricerca ha salvato le informazioni relative al blocco di conversation item
                - Il sistema di ricerca ha salvato gli embedding relativi al blocco di conversation item
                - Il sistema di ricerca ha salvato le informazioni di lingua relative al blocco di conversation item
                        ],
        scenario-principale:[
                + Companion carica un blocco di conversation item
                + Il sistema di ricerca salva i dati dei conversation item
                ...
                + Il sistema di ricerca salva il blocco di conversation item
        ],
