...
#use-case(
        ...
        post-condizioni: [
                - Il sistema di ricerca ha salvato le informazioni relative alla lista di ticket
                - Il sistema di ricerca ha salvato gli embedding relativi alla lista di ticket
                - Il sistema di ricerca ha salvato le informazioni di lingua relative alla lista di ticket
                        ],
        scenario-principale:[
