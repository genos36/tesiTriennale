...
#let use-case-nome="Visualizzazione retrieval latency con ingestion attiva"
// #let depth=
...
#use-case(
        ...
        scenario-principale:[
                + Il supervisore visualizza la retrieval latency media calcolata durante la presenza di un processo di ingestion 
                ],
