...
- Le citazioni ad un libro o ad una risorsa presenti nella #link(<bibliography>)[bibliografia (p. #context counter(page).at(<bibliography>).at(0))] saranno affiancate dal rispettivo numero identificativo, es. [1];
