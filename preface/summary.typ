...
\ \
Questa tesi tratta la progettazione e lo sviluppo di un sistema #gl("rag")
...
- Per la prima occorrenza dei termini riportati nel glossario viene utilizzata la seguente nomenclatura: \; // <-- Usa direttamente l'Adapter!
